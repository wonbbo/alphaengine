...
NON_FINANCIAL_EVENT_TYPES: set[str] = {
    ...
    "QuarantineStarted",
    "QuarantineCompleted",
    # 입출금 진행 이벤트 (Ledger는 DepositCompleted/WithdrawCompleted만 분개)
    "DepositInitiated",
    "DepositTrxPurchased",
    "DepositTrxSent",
    "DepositTrxReceived",
    "DepositUsdtConverted",
    "DepositSpotTransferred",
    "WithdrawInitiated",
    "WithdrawFuturesTransferred",
    "WithdrawUsdtConverted",
    "WithdrawTrxSent",
    "WithdrawTrxReceived",
    "WithdrawKrwConverted",
    "DepositDetected",
    "WithdrawRequested",
    "WithdrawFailed",
}
